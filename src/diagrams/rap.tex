...
\begin{tikzpicture}[
  ...
  \node[data,fill=red!30] (manif) at (3,0) { \parbox{4em}{\centering Manifest\\file} };
  ...
  \node[data] (job) at (4,3) { \parbox{4em}{\centering Validation\\method} };
  ...
  \node[box,fill=magenta!30] (rap) at (10,0.25) { \parbox{4em}{\centering SAVED\\RAP} };
  \draw[used] (rap) -- (fisup);
  \node[data,fill=magenta!30] (out) at (10,-2.5) { \parbox{4em}{\centering Validation\\results} };
